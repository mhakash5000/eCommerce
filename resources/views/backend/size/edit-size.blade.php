        ...
        <div class="card-body ">
            <div class="row">
                <div class="col-md-12  d-flex justify-content-between align-items-center">
                  ...
                  <a href="{{route('size.view')}}" class="btn btn-warning text-dark"> <i class="fa fa-list"></i> Color List</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{route('size.update',$data->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id=""  type="text" placeholder="Update size Name" value="{{$data->name}}" required>
                </div>
                <div class="form-group">
